...
public class User  implements java.io.Serializable {
	...
	public String toString() {
		return "User [email=" + email + ", emailSessionNotifications=" + emailSessionNotifications + ", firstName="
				+ firstName + ", groupMemberships=" + Arrays.toString(groupMemberships) + ", lastName=" + lastName
				+ ", systemRole=" + systemRole + ", userBio=" + userBio + ", userId=" + userId + ", userKey=" + userKey
