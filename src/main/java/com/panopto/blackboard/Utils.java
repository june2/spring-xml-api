...
public class Utils {
	...
	private static final Logger mLog = LoggerFactory.getLogger(Utils.class);
	
    // These identify the Building Block to Blackboard.  Set in bb-manifest.xml.
    public static final String vendorID = "ppto";
    public static final String pluginHandle = "panopto-online-attendance";
...
//        String signedPayload = payload + "|" + pluginSettings.getApplicationKey(serverName);
    		String signedPayload = payload + "|" + pluginSettings.getApplicationKey(serverName);
    		mLog.debug("generateAuthCode ::: " + serverName);
    		mLog.debug("generateAuthCode ::: " + payload);
    		mLog.debug("generateAuthCode ::: " + signedPayload);
